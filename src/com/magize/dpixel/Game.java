...
import com.magize.dpixel.gfx.SpriteSheet;
...
public class Game extends Canvas implements Runnable {
	...
	public Game() {
		setMinimumSize(new Dimension(WIDTH*SCALE, HEIGTH*SCALE));
		setMaximumSize(new Dimension(WIDTH*SCALE, HEIGTH*SCALE));
